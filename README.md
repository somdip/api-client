...
- Step 3: Complie the spring boot project using mvn clean install and mvn spring-boot:run to run the servlet container. Once the spring boot server is up and running you can access the client page using http://127.0.0.1:8887(as shown in yellow) This is the client URL. 
